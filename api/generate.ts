...
7.1. لینک داخلی فقط اگر جمله واقعاً طبیعی و مرتبط شد مجاز است؛ حداکثر ۱ لینک با تگ <a href="#">متن لینک مرتبط</a> بگذار. برای گذاشتن لینک، جمله مصنوعی نساز. اگر لینک باعث غیرطبیعی شدن متن می‌شود، اصلاً لینک نگذار. کیفیت و طبیعی بودن متن از لینک مهم‌تر است.
...
- لینک داخلی اجباری نیست. اگر جمله کاملاً طبیعی شد، حداکثر ۱ لینک داخلی قابل ویرایش با href="#" بگذار؛ اگر باعث مصنوعی شدن متن می‌شود، لینک نگذار.
...
# قانون‌های بسیار مهم
- متن باید بین ۲۵۰ تا ۳۸۰ کلمه باشد و برای Yoast SEO خوانایی خوبی داشته باشد: جمله‌ها کوتاه، پاراگراف‌ها منظم، تیترها واضح و کلمات انتقالی طبیعی باشند.
...
- لینک داخلی اجباری نیست. اگر جمله کاملاً طبیعی و مفید شد، حداکثر ۱ لینک داخلی قابل ویرایش به شکل <a href="#">عبارت مرتبط</a> با href="#" بگذار. اگر لینک باعث جمله‌سازی مصنوعی می‌شود، لینک نگذار. بخش جداگانه برای لینک نساز.
...
# کنترل کیفیت طبیعی بودن متن
- هر جمله باید مستقیماً به خود محصول مربوط باشد و از نظر کاربرد واقعی درست باشد.
...
<p>مقدمه‌ای طبیعی و فروشگاهی درباره محصول، شامل correctedProductName و کلیدواژه کانونی. این پاراگراف باید کاربرد واقعی محصول و دلیل خرید آن را بدون اغراق توضیح دهد.</p>
<hr />
...
<p>در یک پاراگراف کامل و واقعی توضیح بده این محصول چه مزیتی برای خریدار دارد. مزایا باید مخصوص همین محصول باشد و با کاربرد واقعی آن جور دربیاید.</p>
<hr />
...
function getNaturalInlineLinkSentence(
  ...
  if (has([/کافی\s*میت|coffee\s*mate|creamer|پودر خامه|قهوه|کافی|نسکافه|کاپوچینو|coffee|nescafe/])) {
    return 'این محصول برای نرم‌تر کردن طعم قهوه، چای یا نوشیدنی‌های گرم کاربرد دارد و کنار محصولات بخش <a href="#">انواع قهوه</a> بهتر دیده می‌شود.';
  }
